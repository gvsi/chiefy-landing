...
Estàs ofegat a la teva safata d'entrada? No estàs sol. Amb [**376.000 milions de correus electrònics que s'enviaran diàriament l'any 2025**](https://www.dash.app/blog/email-marketing-statistics), no és estrany que el professional mitjà passi [**unes 5 hores a la setmana**](https://www.dragapp.com/blog/effects-of-email-overload/) només gestionant missatges, o aproximadament [**28% de la seva setmana laboral**](https://hiverhq.com/blog/ai-email-triage). Aquest diluvi constant no només requereix temps; és una font important d'estrès i una pèrdua de productivitat.
...
Els correus electrònics ben elaborats són fonamentals per [**crear confiança i credibilitat**](https://www.onlinereputation.com/the-reputation-impact-of-using-a-personal-vs-business-email-for-everything/). Com diu Alok Agarwal de Mailmodo, "el correu electrònic és més que una eina de comunicació; és una línia directa al cor del consumidor". Una comunicació coherent i professional reforça els valors de la vostra marca personal o empresarial. Per contra, els correus electrònics descuidats o poc professionals erosionen aquesta confiança.


El cost d'equivocar-se és alt. Els missatges poc clars condueixen a [**malentesos i temps perdut**](https://hurleywrite.com/Blog/2065/why-is-email-etiquette-important-in-the-workplace/), que requereixen aclariments frustrants d'anada i tornada. Un to deficient pot danyar les relacions, i ignorar els correus electrònics o respondre de manera poc professional pot provocar una insatisfacció important del client. Aquesta petjada digital contribueix a la vostra reputació en línia global, un factor crític, tenint en compte que [**el 90% dels consumidors declaren evitar empreses amb mala reputació**](https://electroiq.com/stats/reputation-management-statistics/) i els reclutadors comproven sovint la presència en línia dels candidats.
...
- **Sigues concís**: intenta [**menys de 60 caràcters**](https://quickmail.com/write-professional-email) per assegurar-te que sigui totalment visible als dispositius mòbils.
...
| -------------------- | ----------------------------------------- | ------------------------------------------------ |
| Reunió | Sol·licitud: Reunió pressupostària dijous 14 h | Específic, inclou acció, temps i tema |
| Actualització | Projecte Phoenix: actualització setmanal d'estat | Identifica projecte, tipus d'actualització |
| Pregunta ràpida | Pregunta re: Dades de l'informe de màrqueting Q3 | Tema específic, permet prioritzar |
| Seguiment | Seguiment: la nostra conversa a | Proporciona context, ajuda a recordar |
| Important!           | Acció necessària: enviar full de temps per EOD | Acció clara, termini concret, transmet urgència |
...
- **Condueix amb la línia de fons**: comença amb el teu punt principal, sol·licitud o la informació més important [**dins de les primeres frases**](https://www.govloop.com/from-harvard-business-review-best-practices-to-write-e-mails-that-impress/). Els professionals ocupats sovint ho fan, així que no enterreu el lede.


- **Proporciona context**: després del punt principal, ofereix els antecedents o els detalls necessaris.


- **Manteniu-lo escanejable**: feu servir [**paràgrafs curts (4-5 frases com a màxim)**](https://www.boisestate.edu/writingcenter/professional-email-guide/). Utilitzeu vinyetes, llistes numerades i text en negreta per dividir la informació i destacar els punts clau. Un ampli espai en blanc millora la llegibilitat.


- **Sigues concís**: Respecta el temps del lector. Retalla paraules innecessàries i frases redundants. Eviteu l'argot tret que el vostre públic sigui específic i ho entendrà. Si és possible, mantingueu el missatge principal [**ajustant en una pantalla**](https://www.govloop.com/from-harvard-business-review-best-practices-to-write-e-mails-that-impress/).
...
- **Format**: manteniu-lo concís ([**4-5 línies com a màxim recomanat**](https://www.roberthalf.com/us/en/insights/career-development/email-signature-etiquette-the-good-the-bad-and-the-unnecessary)), utilitzeu [**tipus de lletra segurs per a web**](https://www.mailerlite.com/blog/email-signature-best-practices) (com Arial, Calibri) i colors coherents amb la vostra marca. Assegureu-vos que sigui [**apte per a mòbils**](https://www.roberthalf.com/us/en/insights/career-development/email-signature-etiquette-the-good-the-bad-and-the-unnecessary). Eviteu imatges innecessàries, logotips grans o cites inspiradores.




![Exemple de signatura de correu electrònic professional neta amb nom, títol, empresa, telèfon, lloc web i enllaç LinkedIn](/blog/images/VbJogfeb4mpoTB52t2fXhppUhJM.png)
...
Les faltes ortogràfiques, els errors ortogràfics i els errors gramaticals criden descuit.8 De seguida [**perjudiquen la vostra credibilitat**](https://pushfar.com/index.php/article/4-reasons-effective-email-communication-is-essential-for-career-success/) 5 i poden fer que el vostre missatge sigui confús o sembli poc professional.8
...
- Per als correus electrònics importants, [**feu-vos una breu pausa**](https://www.govloop.com/from-harvard-business-review-best-practices-to-write-e-mails-that-impress/) (fins i tot 15 minuts) abans de corregir-ho amb ulls nous.


- Penseu en utilitzar [**eines de comprovació de gramàtica i estil**](https://www.betterup.com/blog/how-to-write-a-professional-email) com Grammarly o ProWritingAid com a capa de defensa addicional.


### **Domina el teu to: professionalitat amb personalitat**


El correu electrònic no té els matisos de la conversa cara a cara: sense to de veu, sense expressions facials. Això fa que [**interpretació errònia sigui increïblement fàcil**](https://www.pon.harvard.edu/daily/conflict-resolution/pros-and-cons-of-email-communication/). El que preteneu com a eficient pot semblar brusc; el que penses com a divertit pot caure o ofendre.
...
| **Àrea** | **Fes** | **No** |
| ---------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------|
| **Línia d'assumpte** | Sigues clar, concís, concret. Utilitzeu paraules clau. Indiqueu l'acció necessària.                            | Deixa en blanc. Utilitzeu termes vagues. Utilitzeu TOTES MAJÚSCULES o una puntuació excessiva.                                     |
| **Salut** | Utilitzeu la formalitat adequada ("Estimat", "Hola", "Hola"). Revisa l'ortografia. Sigueu neutre en el gènere si no esteu segurs. | Fes servir salutacions excessivament casuals ("Hey", "Yo") tret que sigui adequat. Utilitzeu "A qui pot interessar" si es pot evitar. |
| **To** | Sigues professional, educat, positiu. Adaptar-se al públic/context.                                   | Ser massa emocional (enfadat, sarcàstic). Utilitzeu l'humor sense cura. Utilitzeu TOTES EN majúscules.                              |
| **Format** | Utilitzeu paràgrafs curts, vinyetes. Utilitzeu tipus de lletra estàndard i llegibles (Arial, Calibri) i colors (negre).  | Escriu blocs de text llargs i densos. Utilitzeu diversos tipus de lletra/colors/mides.                                       |
| **Annexos** | Esmenta els adjunts al cos. Penseu en els enllaços per a fitxers grans.                                | Envieu fitxers grans sense avís.18 Oblideu-vos d'adjuntar el fitxer.                                           |
| **Resposta/CC/BCC** | Utilitzeu Respon-Tots amb moderació (només si cal saber-ho tots). Utilitzeu BCC per a correus electrònics massius/privadesa.            | Per defecte, Respon-Tots. Exposeu les llistes de correu electrònic utilitzant CC en lloc de CCO.                                        |
| **Correcció** | Revisa cada correu electrònic. Llegeix en veu alta.                                                              | Confieu únicament en la correcció ortogràfica. Envieu correus electrònics amb errors ortogràfics o gramaticals.                                     |
| **Firma** | Incloeu informació de contacte essencial. Mantingueu-lo net, concís i adaptat per a mòbils.                        | Incloeu cites innecessàries o imatges grans. Utilitzeu tipus de lletra/colors no professionals. Oblideu un tancament.          |
...
- **Resum intel·ligent**: ofegar-se en fils llargs? AI pot [**generar resums concisos**](https://slack.com/blog/transformation/transform-your-email-experience-with-an-ai-email-assistant), destacant punts clau i elements d'acció perquè pugueu comprendre el context ràpidament.
