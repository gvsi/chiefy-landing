...
Nếu bạn đang đọc điều này, rất có thể bạn đã biết cuộc đấu tranh. Cơn lũ email hàng ngày mà các chuyên gia bận rộn, người làm việc tự do, nhóm khởi nghiệp và người lao động tri thức phải đối mặt là có thật. Theo báo cáo, nhân viên văn phòng trung bình nhận được khoảng [121 email_mỗi ngày_](https://www.emailmeter.com/blog/track-time-spent-on-email) và có thể dành tới [ba giờ mỗi ngày](https://www.adobe.com/news-room/press-releases/2018/08/27/adobes-2018-consumer-email-survey.html) chỉ để quản lý email công việc của họ. Những rào cản liên tục này dẫn đến cảm giác choáng ngợp, lo lắng vì bỏ lỡ những thông điệp quan trọng và mất đi thời gian tập trung quý giá một cách bực bội.

Việc tìm kiếm các lựa chọn thay thế Superhuman không chỉ dừng lại ở mức giá cao, mặc dù đó chắc chắn là một yếu tố đối với nhiều người. Nó ngày càng được thúc đẩy bởi những tiến bộ nhanh chóng trong AI, cung cấp những cách mới về cơ bản để chinh phục hộp thư đến vượt xa tốc độ đơn thuần. Người dùng hiện đang tìm kiếm sự hỗ trợ_thông minh_– các công cụ có thể ưu tiên, tóm tắt, soạn thảo câu trả lời một cách xác thực, tích hợp liền mạch với các quy trình làm việc khác và cung cấp các tính năng cụ thể mà Superhuman có thể thiếu. Thị trường phản ánh điều này, chuyển từ trọng tâm chính vào tốc độ sang trọng tâm mới vào thông minh AI tích hợp.
...
Nhận diện được làn sóng AI, Superhuman vẫn chưa đứng yên. Nó đã tích hợp các khả năng AI đáng kể, bao gồm cả các chuỗi dài, ["Viết bằng AI"](https://superhuman.com/ai) để tìm hiểu và bắt chước phong cách viết độc đáo của bạn, đề xuất Trả lời tức thì và tính năng tìm kiếm ngôn ngữ tự nhiên ["Hỏi AI"](https://superhuman.com/ai). Đối với nhiều người phải xử lý khối lượng email lớn, Superhuman lần đầu tiên khiến email có cảm giác dễ quản lý, thậm chí là mạnh mẽ.

Tuy nhiên, chính những yếu tố xác định Superhuman cũng tạo ra lý do để người dùng tìm kiếm ở nơi khác.

- **Thẻ giá:** Với mức giá khởi điểm là [$30 mỗi tháng](https://superhuman.com/pricing) (hoặc $25/tháng thanh toán hàng năm), Superhuman thể hiện một khoản đầu tư định kỳ đáng kể. Đối với những người làm việc tự do, các nhóm nhỏ hoặc thậm chí cả những cá nhân nhạy cảm với chi phí đăng ký, đây có thể là một trở ngại lớn, đặc biệt là khi có nhiều lựa chọn thay thế có khả năng cung cấp các cấp độ miễn phí hoặc có mức giá thấp hơn đáng kể. Chi phí cao này đương nhiên tạo ra cơ hội mở cửa thị trường cho các đối thủ cạnh tranh.

- **Khóa nền tảng:** Tốc độ và trải nghiệm được tuyển chọn của Superhuman một phần đến từ sự tích hợp chặt chẽ của nó, nhưng điều này có nghĩa là nó chỉ hoạt động với [tài khoản Gmail và Outlook](https://clean.email/blog/email-clients/superhuman-review). Người dùng của các nhà cung cấp email khác bị loại trừ. Hơn nữa, nó không hỗ trợ nhiều tiện ích mở rộng trình duyệt mà nhiều người dựa vào trong môi trường Gmail hoặc Outlook gốc. Thiết kế tập trung này, tuy là điểm mạnh về tốc độ, nhưng lại hạn chế khả năng ứng dụng của nó đối với người dùng bên ngoài hệ sinh thái được hỗ trợ.

- **Những lỗ hổng và đặc điểm về tính năng:** Mặc dù mạnh mẽ nhưng nó không hoàn hảo. Một số đánh giá đề cập đến những hạn chế như thiếu chế độ xem hộp thư đến thực sự thống nhất trên nhiều tài khoản đã thêm, khó đính kèm email dưới dạng tệp 26, khoảng trống tích hợp cụ thể 23 hoặc AI không giữ lại ngữ cảnh trên các chuỗi riêng biệt. Những lo ngại ban đầu về quyền riêng tư liên quan đến biên nhận đã đọc, mặc dù được giải quyết bằng cách [xóa theo dõi vị trí và cho phép họ chọn tham gia](https://mikeindustries.com/blog/archive/2019/07/superhumans-superficial-privacy-fixes-do-not-prevent-it-from-spying-on-you), vẫn liên quan đến việc theo dõi hành động của người nhận mà không có sự đồng ý rõ ràng. Cuối cùng, cuộc gọi giới thiệu 1:1 bắt buộc, mặc dù nhằm đảm bảo người dùng tối đa hóa công cụ, nhưng có thể là rào cản đối với những người thích thiết lập tự phục vụ.
...
Hãy xem xét việc lãng phí thời gian: người lao động dành [giờ mỗi ngày](https://www.adobe.com/news-room/press-releases/2018/08/27/adobes-2018-consumer-email-survey.html) chỉ để quản lý email, thường xuyên kiểm tra hộp thư đến của họ với tần suất đáng báo động – đôi khi [15 lần mỗi giờ trở lên](https://www.sixthcitymarketing.com/email-marketing-stats/). Việc kiểm tra liên tục này sẽ làm phân tán sự chú ý. Nghiên cứu nhất quán cho thấy rằng việc khôi phục sau khi bị gián đoạn, chẳng hạn như xem qua thông báo email mới, có thể mất [hơn 20 phút](https://www.loom.com/blog/cost-of-context-switching) để lấy lại hoàn toàn sự tập trung vào nhiệm vụ ban đầu.39 Việc "chuyển ngữ cảnh" này là nguyên nhân hủy diệt năng suất lớn, có khả năng làm giảm sản lượng [lên tới 40%](https://asana.com/resources/context-switching) đồng thời làm tăng căng thẳng, tải trọng nhận thức và khả năng xảy ra lỗi.

Vấn đề phức tạp hơn là khối lượng khổng lồ – [hàng trăm tỷ email](https://www.statista.com/statistics/456500/daily-number-of-e-mails-worldwide/) bay qua internet hàng ngày – và thực tế là một phần đáng kể không quan trọng hoặc không yêu cầu hành động ngay lập tức. Việc tìm kiếm tín hiệu quan trọng trong bối cảnh tiếng ồn quá lớn là một thách thức lớn. Sự kém hiệu quả này không chỉ gây khó chịu; nó chuyển thành chi phí kinh doanh thực tế do trễ thời hạn, lãng phí nguồn lực và làm lại không cần thiết.
...
- **Các tính năng chính của AI:** Spark tự hào có ["+AI Writing Assistant"](https://sparkmailapp.com/) toàn diện để soạn thảo, tóm tắt các chủ đề dài, tạo câu trả lời nhanh, diễn đạt lại văn bản cho rõ ràng hoặc có giọng điệu, hiệu đính và thậm chí là dịch email.61

- **Các tính năng nổi bật khác:** Tôi tự động sắp xếp email (người, bản tin, thông báo). Nó vượt trội trong việc cộng tác nhóm với các bản nháp được chia sẻ, nhận xét nội bộ về email và ủy quyền thư. Nó tích hợp với các công cụ như [Asana](https://asana.com/), Trello và [Dropbox](https://www.dropbox.com/).

- **Giá cả và đối tượng:** Cung cấp [cấp miễn phí](https://sparkmailapp.com/pricing) mạnh mẽ. Các gói cao cấp có giá khởi điểm khoảng 4,99 USD/tháng cho cá nhân và 6,99 USD/người dùng/tháng cho nhóm (thanh toán hàng năm). Nó rất phù hợp cho các nhóm cần cộng tác, những cá nhân quan tâm đến ngân sách và người dùng trên nhiều nền tảng bao gồm cả Android.
...
- **Các tính năng chính của AI:** Có [trợ lý AI](https://www.shortwave.com/) để tóm tắt các chủ đề, soạn thảo câu trả lời (tìm hiểu phong cách của bạn), tìm kiếm bằng ngôn ngữ tự nhiên, lên lịch trợ giúp và đề xuất tự động hoàn thành thông minh dựa trên lịch sử email. Gói trả phí mở khóa bộ lọc AI và phân tích tệp đính kèm.

- **Các tính năng nổi bật khác:** Mô hình tổ chức cốt lõi của nó bao gồm (https\://www\.shortwave.com/) (nhóm các email tương tự như bản tin hoặc cập nhật), Chia hộp thư đến để có chế độ xem tập trung và khả năng biến email thành Todos có thể theo dõi. Gói trả phí bổ sung thêm các tính năng nhóm như nhận xét, bài tập và nhãn chia sẻ.

- **Giá cả và đối tượng:** Cung cấp [cấp miễn phí](https://www.shortwave.com/pricing/) chức năng. Gói Pro bắt đầu ở mức $14/chỗ/tháng (thanh toán hàng năm). Lý tưởng cho những người dùng và nhóm thành thạo Gmail đang tìm kiếm tổ chức và phân loại tiên tiến dựa trên AI.
...
- **Các tính năng chính của AI:** ["AI Copilot"](https://canarymail.io/) hỗ trợ viết và hiệu đính email, đề xuất trả lời, cung cấp bản tóm tắt các chủ đề và thông tin chi tiết về mức độ ưu tiên. Canary cũng sử dụng AI để phát hiện mối đe dọa nâng cao (lừa đảo, mạo danh).

- **Các tính năng nổi bật khác:** Bảo mật là điều tối quan trọng, cung cấp mã hóa PGP hai đầu và SecureSend (hữu ích cho việc tuân thủ HIPAA). Nó có hộp thư đến hợp nhất cho nhiều loại tài khoản (Gmail, Outlook, iCloud, v.v.), mẫu email, báo lại, biên nhận đã đọc và các công cụ dọn dẹp hàng loạt trên Mac, iOS, Android và Windows.

- **Giá cả và đối tượng:** Cung cấp [dùng thử miễn phí](https://canarymail.io/pricing), với các gói trả phí bắt đầu khoảng $3/tháng ($36/năm). Kêu gọi mạnh mẽ các cá nhân và nhóm quan tâm đến quyền riêng tư, bao gồm cả những người trong các ngành được quản lý, những người cũng muốn hỗ trợ AI mà không phải trả giá đắt.
...
| ------------------------ | ------------------------------------------------ | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | -------------------------------------------- |
|**Trọng tâm chính** | Tốc độ, Quy trình làm việc trên bàn phím, Trải nghiệm cao cấp | Cộng tác, Hộp thư đến thông minh, Viết AI | AI Tổ chức, phân loại, Cải tiến Gmail | Bảo mật, Quyền riêng tư, Hỗ trợ AI |
|**AI Triage/Ưu tiên** | Tách hộp thư đến, nhãn tự động | Hộp thư đến thông minh, Sắp xếp ưu tiên | Các gói, AI Tổ chức, Chia hộp thư đến | Sắp xếp thông minh, Thông tin chi tiết ưu tiên |
|**Phong cách soạn thảo AI** | Tìm hiểu giọng nói của người dùng, tập trung | Lời nhắc linh hoạt, Điều chỉnh giọng điệu | Tìm hiểu giọng nói của người dùng, Tự động hoàn thành | AI Viết/ hiệu đính phi công phụ |
|**Tóm tắt AI** | Có (Tự động tóm tắt) | Có (Tóm tắt) | Có (Tóm tắt tức thì) | Có (Tóm tắt AI) |
|**Tập trung hợp tác** | Trung bình (Đoạn trích nhóm, Chủ đề được chia sẻ) | Cao (Bản nháp/Nhận xét được chia sẻ, Đại biểu) | Trung bình (Nhận xét, Phân công - Trả phí) | Thấp (Sử dụng cá nhân/nhóm, ít tập trung cộng tác hơn) |
|**Tích hợp chính** | Hubspot, Lực lượng bán hàng | [Asana](https://asana.com/),Trello, [Dropbox](https://www.dropbox.com/), v.v. | [Lịch Google](https://calendar.google.com/), [Zapier](https://zapier.com/) (Doanh nghiệp) | Lịch cơ bản |
|**Hỗ trợ nền tảng** | Mac, Win, iOS, Android, Web (chỉ Gmail/Outlook) | Mac, Win, iOS, Android | iOS, Android, Web (Máy tính để bàn PWA) (chỉ Gmail) | Mac, Win, iOS, Android |
|**Mô hình định giá** | Đăng ký trả phí | Freemium | Freemium | Freemium (Dùng thử rồi trả phí) |
|**Có sẵn cấp miễn phí?** | Không (Yêu cầu giới thiệu) | Có | Có | Không (Dùng thử miễn phí) |
...
Mục tiêu cuối cùng vẫn như cũ: vượt qua sự căng thẳng và mất tập trung liên tục khi hộp thư đến tràn ngập, lấy lại thời gian tập trung quý giá và tăng năng suất tổng thể. Chọn công cụ email phù hợp là một khoản đầu tư để đạt được trạng thái kiểm soát bình tĩnh đó. Câu chuyện đang chuyển từ chỉ đơn giản là "quản lý email" sang tích hợp thông tin email một cách liền mạch vào quy trình làm việc rộng hơn của bạn.
